...
namespace Market.DAL.IDAL
{
    public interface IOrderService
    {
        ...
        /// <summary>
        /// Creates a new order by the product's ID.
        /// </summary>
        ...
        /// <summary>
        /// Updates the quantity of an order by the order's ID.
        /// </summary>
        ...
        /// <summary>
        /// Updates the quantity of an order by the product's ID.
        /// </summary>
        ...
        /// <summary>
        /// Deletes an order by the product's ID.
        /// </summary>
        /// <param name="productId">The ID of the product associated with the order.</param>
        /// <returns></returns>
